...
// SECURITY WARNING: This file contains sensitive credentials and should NEVER be committed to version control.
...
try {
  ...
  console.error('SECURITY NOTE: Never commit this file to Git or share it publicly');
  process.exit(1);
}
